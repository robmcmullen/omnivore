...
from omnivore8bit.bitmap_edit.bitmap_editor import MainBitmapScroller, BitmapEditor
from omnivore8bit.arch.machine import Machine, predefined
...
class JumpmanEditor(BitmapEditor):
    ...
    def from_metadata_dict(self, e):
        ...
        BitmapEditor.from_metadata_dict(self, e)
    ...
    def to_metadata_dict(self, mdict, document):
        ...
        BitmapEditor.to_metadata_dict(self, mdict, document)
