...
if "clean" in sys.argv:
    ...
    extensions = [
        ...
        # TEMPORARILY DISABLING ATARI800 while converting to libdebugger2
        ...
        #     undef_macros = [ "NDEBUG" ],
        # ),
        Extension("omnivore.emulators.libemu",
            sources = [
                "libemu/disasm.c",
                "libemu/libemu.pyx",
                ...
                "libemu/breakpoints.c",
                "libemu/op_history.c",
                "libemu/save_state.c",
                "libemu/parse_udis_cpu.c",
                "libemu/parse_custom.c",
                "libemu/util6502.c",
            ],
            depends = [
