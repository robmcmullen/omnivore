...
class Machine(HasTraits):
    ...
    def get_disassembler(self, hex_lower, mnemonic_lower, byte_mnemonic):
        return self.disassembler(self.assembler, self.memory_map, hex_lower, mnemonic_lower, byte_mnemonic)
