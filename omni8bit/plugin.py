...
class OmnivoreEditorPlugin(FrameworkPlugin):
    ...
    def _preferences_panes_default(self):
        from omni8bit.hex_edit import HexEditPreferencesPane
        from omni8bit.bitmap_edit import BitmapEditPreferencesPane
        from omni8bit.jumpman import JumpmanPreferencesPane
        return [ HexEditPreferencesPane, BitmapEditPreferencesPane, JumpmanPreferencesPane]

    def _tasks_default(self):
        from omni8bit.hex_edit import HexEditTask
        from omni8bit.map_edit import MapEditTask
        from omni8bit.bitmap_edit import BitmapEditTask
        from omni8bit.jumpman import JumpmanEditTask
