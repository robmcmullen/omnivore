...
from omni8bit.map_edit.pane_layout import task_id_with_pane_layout as map_edit_task_id
from omni8bit.jumpman.pane_layout import task_id_with_pane_layout as jumpman_task_id
