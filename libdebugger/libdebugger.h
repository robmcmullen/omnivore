...
#define ACCESS_TYPE_CHBASE 5
#define ACCESS_TYPE_PMBASE 6
#define ACCESS_TYPE_SELF_MODIFYING_CODE 7
#define ACCESS_TYPE_HARDWARE 0x7f

#define ACCESS_TYPE_READ_NORMAL (ACCESS_TYPE_READ | ACCESS_TYPE_NORMAL)
#define ACCESS_TYPE_WRITE_NORMAL (ACCESS_TYPE_WRITE | ACCESS_TYPE_NORMAL)
#define ACCESS_TYPE_READ_HARDWARE (ACCESS_TYPE_READ | ACCESS_TYPE_HARDWARE)
#define ACCESS_TYPE_WRITE_HARDWARE (ACCESS_TYPE_WRITE | ACCESS_TYPE_HARDWARE)
