...
class TestSmall(object):
    ...
    def test_simple(self):
        ...
        s = self.editor.segment
        r, style = s.get_entire_style_ranges(user=user_bit_mask, split_comments=[data_style])
        print_r(r)

        match = [((0x0000, 0x000b), 0), ((0x000b, 0x000c), 1), ((0x000c, 0x000d), 1), ((0x000d, 0x000e), 1), ((0x000e, 0x000f), 0), ((0x000f, 0x0012), 1), ((0x0012, 0x0014), 0), ((0x0014, 0x0017), 1), ((0x0017, 0x0018), 0), ((0x0018, 0x001b), 1), ((0x001b, 0x001d), 1), ((0x001d, 0x001e), 1), ((0x001e, 0x001f), 0)
]
        print_r(match)
