...
\begin{flushleft}
\includegraphics[width=1.0\textwidth]{../../../omnivore/icons/omnivore256.png}\\[1cm]
\end{flushleft}
\end{minipage}
\begin{minipage}{0.75\textwidth}
\begin{flushright}

{ \Huge \CTV Omnivore XL User Manual}\\[0.4cm]
...
# toctree_only).
latex_documents = [
  ('index', 'UserManual.tex', 'Omnivore XL User Manual', 'Rob McMullen', 'manual', True),
]
