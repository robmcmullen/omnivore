...
class FrameworkApplication(TasksApplication, FilePersistenceMixin):
    ...
    id = 'omnivore_framework.framework.application'
    ...
    startup_task = Str('omnivore_framework.framework.text_edit_task')
    ...
    def build_docs(self):
        ...
        for factory in self.task_factories:
            ...
            # if not factory.id.startswith("omnivore_framework.map_edit"):
            #     print "Skipping documentation for %s" % factory.id
            #     continue
