...
if __name__ == '__main__':
    ...
    log = logging.getLogger("omnivore_framework.framework")
    log = logging.getLogger("omnivore_framework.framework.editor")
    log = logging.getLogger("omnivore8bit.hex_edit")
    log = logging.getLogger("omnivore_framework.utils.wx.error_logger")
