...
CURRENT_STATE_JMP = 1
CURRENT_STATE_BRANCH = 2
CURRENT_STATE_BRANCH_TAKEN = 4
CURRENT_STATE_COMPUTED_ADDR = 8
CURRENT_STATE_MEMORY_READ = 0x10
CURRENT_STATE_MEMORY_WRITE = 0x20
CURRENT_STATE_BYTE_REGISTER = 0x40
CURRENT_STATE_WORD_REGISTER = 0x80
CURRENT_STATE_OPCODE_ADDR = 0x100
CURRENT_STATE_OTHER_DISASSEMBLER_TYPE = 0x8000
