...
class ByteEditor(TileManagerBase):
    ...
    ["View", "view_width", "view_zoom", ["Colors", "view_color_standards", None, "view_antic_powerup_colors", None, "view_ask_colors"], ["Bitmap", "view_bitmap_renderers"], ["Text", "view_font_renderers", None, "view_font_mappings"], ["Font", "view_fonts", None, "view_load_font", "view_font_from_selection", "view_font_from_segment"]],
    ...
    ["Disk Image", ["CPU", "doc_cpu"], ["Operating System", "doc_os_labels"], ["Assembler Syntax", "doc_assembler"]],
    ["Help", "about"],
    ]
