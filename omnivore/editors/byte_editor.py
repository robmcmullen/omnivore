...
class ByteEditor(TileManagerBase):
    ...
    ["View", "view_width", "view_zoom", ["Colors", "view_color_standards", None, "view_antic_powerup_colors", None, "view_ask_colors"], ["Font", "view_font_renderers", None, "view_font_mappings"]],
