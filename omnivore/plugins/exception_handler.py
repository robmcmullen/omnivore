...
class ErrorDialog(wx.Dialog):
    ...
    def __init__(self, message):
        ...
        # Attributes
        self.err_msg = FormatErrorMessage(self.task, ErrorReporter().GetErrorStack())
...
class RaiseExceptionAction(Action):
    ...
    tooltip = 'Raise an exception to test the error reporter'

    def perform(self, event):
        val = int("this will raise a ValueError")


class ExceptionHandlerPlugin(FrameworkPlugin):
